          ...
          <div className="bg-white-A700 flex flex-col items-center justify-start md:ml-[0] ml-[978px] mr-6 p-3 md:px-5 rounded-[15px] w-[31%] md:w-full">
            <div className="flex flex-col gap-[30px] items-center justify-start mb-2 w-full">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start rounded-[5px] w-[95%] md:w-full">
                ...
                <Button className="bg-white-A700_b2 black_900_0e_black_900_29_border cursor-pointer min-w-[89px] sm:ml-[0] ml-[109px] outline outline-[1px] py-[7px] rounded-[5px] text-black-900_e4 text-center text-xs">
                  Settings
                </Button>
                <Button className="bg-white-A700_b2 black_900_0e_black_900_29_border2 cursor-pointer min-w-[89px] ml-3.5 sm:ml-[0] outline outline-[1px] py-2 rounded-[5px] text-black-900_e4 text-center text-xs">
                  Clear All
                </Button>
              </div>
              <List
