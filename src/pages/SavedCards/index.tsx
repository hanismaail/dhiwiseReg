                    ...
                    <div className="flex flex-col gap-4 items-center justify-start md:ml-[0] ml-[60px] w-[67%] md:w-full">
                      <div className="flex flex-col gap-2 items-start justify-start w-[500px] sm:w-full">
                        ...
                        <Input
                          ...
                          className="font-medium md:h-auto p-0 placeholder:text-blue_gray-400 sm:h-auto sm:pr-5 text-blue_gray-400 text-left text-lg w-full"
                          wrapClassName="bg-white-A700 border border-blue_gray-100 border-solid pl-3 pr-[35px] py-4 rounded w-full"
                          type="text"
                        ></Input>
                      </div>
